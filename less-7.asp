        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <h1>Less-7</h1>
                        <p class="lead">Blind - Stack - String(with Twist)</p>
                        <p><a class="btn btn-lg btn-success" href="less-7.asp?id=1" role="button">id = 1</a></p>
                    </div>
                    ...
                    <dir class="alert alert-info" role="alert">
                        ...
                        <%
                            ...
                            If Err.Number <> 0 Then
                                Response.Write("You have an error in your SQL syntax")
                                'Response.End()
                            ElseIf rs("id") > 0 Then
