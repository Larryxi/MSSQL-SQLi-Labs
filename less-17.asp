        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <h1>Less-17</h1>
                        <p class="lead">Update Query - Error based - String</p>
                    </div>

                    <div class="row">
                        <form class="form-horizontal" role="form" action="less-17.asp" name="form1" method="post">
                    ...
                    <dir class="alert alert-info" role="alert">
                        ...
                        <%
                            ...
                            If username <> "" And password <> "" Then
                                ...
                                sql_str = "select username, password from users where username='" & username & "'"
                                ...
                                If rs.BOF = False And rs.EOF = False Then
                                    ...
                                    sql_str = "update users set password = '" & password & "' where username='" & real_username & "'"
                                    cmd.CommandText=sql_str
                                    Set rs=cmd.Execute                      
                                    ...
                                    Response.Write("Successfully updated your password")
                                Else
