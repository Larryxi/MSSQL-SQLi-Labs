        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <h1>Less-18</h1>
                        <p class="lead">Header Injection - Stack - string</p>
                    </div>

                    <div class="row">
                        <form class="form-horizontal" role="form" action="less-18.asp" name="form1" method="post">
                        ...
                        <%
                            ...
                            If username <> "" And password <> "" Then
                                ...
                                If rs.BOF = False And rs.EOF = False Then
                                    sql_str = "insert into uagents (uagent, ip_address, username) values ('" & uagent & "', '" & ip & "', '" & username & "')"
                                    cmd.CommandText=sql_str
                                    Set rs=cmd.Execute                      

                                    Response.Write("<br />Your User Agent is: " & uagent)                       
