        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="jumbotron">
                        <h1>Less-1</h1>
                        <p class="lead">Error based - String</p>
                        <p><a class="btn btn-lg btn-success" href="less-1.asp?id=1" role="button">id = 1</a></p>
                    </div>
                    ...
                    <dir class="alert alert-info" role="alert">
                        ...
                        <%
                            ...
                            If Err.Number <> 0 Then
                                ...
                                'Response.End()
                            ElseIf rs("id") > 0 Then 'same as rs.BOF = False And rs.EOF = False Then
                                Response.Write("Your Login name:" & rs("username") & "<br />")
                                Response.Write("Your Password:" & rs("password"))
                            End If
                        %>
                    </dir>
                </div>  
